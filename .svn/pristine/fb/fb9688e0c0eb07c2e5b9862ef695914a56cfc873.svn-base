...
- (void)receiveMsg:(AVIMTypedMessage *)msg conv:(AVIMConversation *)conv {
    ...
    //    NSLog(@"conv.conversationId:%@", conv.conversationId);
    //    NSLog(@"conv.type:%d", conv.type);
...
//                    NSLog(@"--------zhiqian:%ld",[UIApplication sharedApplication].applicationIconBadgeNumber);
                    [UIApplication sharedApplication].applicationIconBadgeNumber+=1;
//                    NSLog(@"--------zhihou:%ld",[UIApplication sharedApplication].applicationIconBadgeNumber);
                }
                else{
//                    [UIApplication sharedApplication].applicationIconBadgeNumber-=1;
                }
...
//                NSLog(@"--------zhihou:%ld",[UIApplication sharedApplication].applicationIconBadgeNumber);
            ...
            //NSLog(@"conversation.name: %@", conversation.name);
            //NSLog(@"conversation.obj: %@", conversation.conversationId);
            //[_storage getAllMsgs];
            ...
            switch (msgType) {
                case MasterDismiss:
                    ...
                    //[_storage deleteMsgsByRealConvid:conversation.conversationId];
                    break;
                case MasterMoveOut:
                    [_storage deleteRoomByConvid:conversation.name];
                    //[_storage deleteMsgsByRealConvid:conversation.conversationId];
