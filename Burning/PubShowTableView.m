...
-(void)didDeletePubButtonClickindexPath:(NSIndexPath *)indexPath{
    if ([_pubShowTableViewDelegate respondsToSelector:@selector(didDeletePubButtonClickindexPath:)]) {
        [_pubShowTableViewDelegate didDeletePubButtonClickindexPath:indexPath];
    }
}
