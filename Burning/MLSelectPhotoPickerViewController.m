...
//    NSString *windowCounts = [NSString stringWithFormat:@"windows.count:%lu",(unsigned long)[UIApplication sharedApplication].windows.count];
//    
//    UIAlertView *alterView = [[UIAlertView alloc]initWithTitle:windowCounts message:nil delegate:nil cancelButtonTitle:@"取消"otherButtonTitles:nil, nil];
//    
//    [alterView show];
