...
-(UILabel*)sigNatureLabel{
    if(!_sigNatureLabel){
        _sigNatureLabel=[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(_usernameLabel.frame), CGRectGetMaxY(_usernameLabel.frame)+kPubShowContentLineSpacing, CGRectGetWidth(_usernameLabel.frame), 18)];
