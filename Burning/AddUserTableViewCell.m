...
-(UILabel*)usernameLabel{
    if(_usernameLabel==nil){
        _usernameLabel=[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_avatarImageView.frame)+kPubShowAvatarSpacing, kPubShowAvatarSpacing,[[self class] contentWidth]-40 , kPubShowUsernameHeight)];
...
//        _sigNatureLabel=[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(_usernameLabel.frame), CGRectGetMaxY(_usernameLabel.frame)+kPubShowContentLineSpacing, CGRectGetWidth(_usernameLabel.frame), 10)];
        _sigNatureLabel=[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(_usernameLabel.frame), CGRectGetMaxY(_usernameLabel.frame)+kPubShowContentLineSpacing, [[self class] contentWidth], 18)];
...
-(UIButton*)selectedButton{
    if (_selectedButton==nil) {
        ...
        _selectedButton.contentVerticalAlignment = UIControlContentVerticalAlignmentTop;
