...
{
    CDBadgeView *badgeViewAppearanceProxy = CDBadgeView.appearance;
...
- (void)layoutSubviews
{
    ...
    switch (self.badgeAlignment) {
        ...
        case JSBadgeViewAlignmentBottomRight:
            newFrame.origin.x = superviewWidth -(viewWidth / 2.0f)-10;
            newFrame.origin.y = superviewHeight - (viewHeight / 2.0f)+5;
            break;
