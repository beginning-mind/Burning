...
@property (weak, nonatomic) IBOutlet UIView *picHolder;
...
@property (weak, nonatomic) IBOutlet UILabel *noAtLabel;
@property (weak, nonatomic) IBOutlet UISwitch *noAtSwitch;
